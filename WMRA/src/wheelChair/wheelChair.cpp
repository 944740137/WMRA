...
ROBOT_MOBILE_BASE::ROBOT_MOBILE_BASE(bool flag){
    ...
    odom_path.header.frame_id ="camera_color_frame";
    path_robot.header.frame_id="camera_color_frame";
    ...
    this->cmd_vel_sub = n.subscribe(smoother_cmd_vel,100,&ROBOT_MOBILE_BASE::cmd_velCallback,this);
